...
customElements.define('action-handler-hadwdforecast', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-hadwdforecast')) {
    return body.querySelector('action-handler-hadwdforecast') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-hadwdforecast');
